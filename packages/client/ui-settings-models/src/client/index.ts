/**
 * Models settings and provider-onboarding plugin, browser half. It registers
 * the Models page and the official-DeepSeek credential onboarding dialog,
...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface LocaleNamespaceMap {
    /** The Models page + provider-onboarding copy. */
