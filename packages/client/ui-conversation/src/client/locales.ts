...
export const zh = {
  ...
  'chat.loadOlder': '加载更早',
  'chat.toBottom': '回到底部',
  'chat.working': 'Mintal正在为你打工～～',
  'chat.waitingForResponse': 'Mintal正在等你吩咐～～',
...
export const en = {
  ...
  'chat.working': 'Mintal is working for you~~',
  'chat.waitingForResponse': 'Mintal is waiting for your instructions~~',
