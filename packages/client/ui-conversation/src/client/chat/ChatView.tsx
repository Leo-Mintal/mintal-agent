...
/** Turn-level status: a pending question means the model is waiting for the user. */
function TurnStatus({ startTime, waitingForResponse, t }: {
  ...
  return (
    <div className={css.turnStatus} role="status" aria-live="polite">
      {waitingForResponse ? t('chat.waitingForResponse') : t('chat.working')}
      {!waitingForResponse && showClock && (
...
export function ChatView({
  ...
  const waitingForResponse = pendingInteractions.some(interaction => interaction.kind === 'question')
    ...
    <div className={css.root}>
      <div ref={listRef} className={css.scroll}>
        <div ref={columnRef} className={css.column} data-chat-flow="">
          ...
          {running && <TurnStatus startTime={runningTurnStart} waitingForResponse={waitingForResponse} t={t} />}
